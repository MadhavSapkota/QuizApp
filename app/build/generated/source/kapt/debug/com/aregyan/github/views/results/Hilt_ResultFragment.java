 ...
 */
public abstract class Hilt_ResultFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ResultFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ResultFragment_GeneratedInjector) this.generatedComponent()).injectResultFragment(UnsafeCasts.<ResultFragment>unsafeCast(this));
    }
  }
