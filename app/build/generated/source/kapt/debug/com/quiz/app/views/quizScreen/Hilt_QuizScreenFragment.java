 ...
 */
public abstract class Hilt_QuizScreenFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QuizScreenFragment() {
    super();
  }

  Hilt_QuizScreenFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QuizScreenFragment_GeneratedInjector) this.generatedComponent()).injectQuizScreenFragment(UnsafeCasts.<QuizScreenFragment>unsafeCast(this));
    }
  }
