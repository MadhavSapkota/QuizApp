...
import com.aregyan.github.views.userDetails.UserDetailsFragment;
import com.aregyan.github.views.userDetails.UserDetailsViewModel;
import com.aregyan.github.views.userDetails.UserDetailsViewModel_HiltModules_KeyModule_ProvideFactory;
import com.aregyan.github.views.userList.UserListFragment;
import com.aregyan.github.views.userList.UserListViewModel;
import com.aregyan.github.views.userList.UserListViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends Application_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(3).add(ResultViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(UserDetailsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(UserListViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends Application_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.userListViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(3).put("com.aregyan.github.views.results.ResultViewModel", ((Provider) resultViewModelProvider)).put("com.aregyan.github.views.userDetails.UserDetailsViewModel", ((Provider) userDetailsViewModelProvider)).put("com.aregyan.github.views.userList.UserListViewModel", ((Provider) userListViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.aregyan.github.views.results.ResultViewModel 
          return (T) new ResultViewModel(viewModelCImpl.userDetailsRepository());

          case 1: // com.aregyan.github.views.userDetails.UserDetailsViewModel 
  ...
  private static final class SingletonCImpl extends Application_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.aregyan.github.network.UserDetailsService 
