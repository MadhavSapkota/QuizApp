...
import com.quiz.app.di.DatabaseModule_ProvideAppDatabaseFactory;
import com.quiz.app.di.DatabaseModule_ProvideChannelDaoFactory;
import com.quiz.app.di.NetworkModule;
import com.quiz.app.di.NetworkModule_ProvideOkHttpClientFactory;
import com.quiz.app.di.NetworkModule_ProvideRetrofitFactory;
import com.quiz.app.di.NetworkModule_ProvideUserDetailsServiceFactory;
import com.quiz.app.network.QuizService;
import com.quiz.app.repository.QuizRepository;
import com.quiz.app.views.dashboard.DashboardFragment;
import com.quiz.app.views.dashboard.DashboardViewModel;
import com.quiz.app.views.dashboard.DashboardViewModel_HiltModules_KeyModule_ProvideFactory;
import com.quiz.app.views.quizScreen.QuizScreenFragment;
import com.quiz.app.views.quizScreen.QuizScreenViewModel;
import com.quiz.app.views.quizScreen.QuizScreenViewModel_HiltModules_KeyModule_ProvideFactory;
import com.quiz.app.views.results.ResultFragment;
import com.quiz.app.views.results.ResultViewModel;
import com.quiz.app.views.results.ResultViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends Application_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(3).add(DashboardViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(QuizScreenViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(ResultViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends Application_HiltComponents.ViewModelC {
    ...
    private Provider<QuizScreenViewModel> quizScreenViewModelProvider;
    ...
    private QuizRepository quizRepository() {
      return new QuizRepository(singletonCImpl.provideUserDetailsServiceProvider.get(), singletonCImpl.questionDao());
    }
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.quizScreenViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
      this.resultViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(3).put("com.quiz.app.views.dashboard.DashboardViewModel", ((Provider) dashboardViewModelProvider)).put("com.quiz.app.views.quizScreen.QuizScreenViewModel", ((Provider) quizScreenViewModelProvider)).put("com.quiz.app.views.results.ResultViewModel", ((Provider) resultViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.quiz.app.views.dashboard.DashboardViewModel 
          return (T) new DashboardViewModel();

          case 1: // com.quiz.app.views.quizScreen.QuizScreenViewModel 
          return (T) new QuizScreenViewModel(viewModelCImpl.quizRepository());

          case 2: // com.quiz.app.views.results.ResultViewModel 
          return (T) new ResultViewModel(viewModelCImpl.quizRepository());
  ...
  private static final class SingletonCImpl extends Application_HiltComponents.SingletonC {
    ...
    private Provider<QuizService> provideUserDetailsServiceProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideUserDetailsServiceProvider = DoubleCheck.provider(new SwitchingProvider<QuizService>(singletonCImpl, 0));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.quiz.app.network.QuizService 
          return (T) NetworkModule_ProvideUserDetailsServiceFactory.provideUserDetailsService(singletonCImpl.provideRetrofitProvider.get());
          ...
          case 3: // com.quiz.app.database.UserDatabase 
